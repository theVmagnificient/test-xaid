        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "The bill would tie the Medicare physician fee schedule update to inflation — specifically the Medicare Economic Index minus one percentage point — instead of the current fixed statutory updates. It would also limit year-to-year changes in the conversion factor to 2.5% to avoid large swings, and raise the budget-neutrality threshold from $20 million to $57.6 million (adjusted for inflation every five years), giving CMS more room to make rate adjustments without triggering across-the-board cuts."
              }
            },
            {
              "@type": "Question",
          ...
          <div className="container-xaid max-w-3xl mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { stat: '$57.6M', label: 'New budget-neutrality floor', sub: 'up from $20M today' },
        ...
        <article className="section-padding bg-[#EBEBEB]">
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                That is how <Link to="/for-teleradiology-companies/" className="text-xaid-blue-strong underline underline-offset-2">xAID is built to work for reading groups</Link>: the AI produces a ready-to-sign structured CT report, xAID's in-house European radiologist reviews every preliminary, and the report is delivered ready-to-sign so your reading radiologist signs the final. The signature — and the accountability — stays with your radiologist. Legislation moves the revenue line slowly and unpredictably; reporting throughput is the margin lever an independent group can pull now.
              </p>
