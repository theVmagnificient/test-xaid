  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <KeyStats
          items={[
            { stat: 'Aug 13, 2026', label: 'Image exchange launched', sub: 'one-click, cross-hospital' },
            { stat: '21,000+', label: 'Scans avoided per year', sub: "by Epic's duplicate-order checks" },
            { stat: '5.8M', label: 'Duplicate orders flagged', sub: "Epic's network, one year" },
            { stat: 'Jan 2026', label: 'ONC imaging RFI scope', sub: 'images, not reports' },
          ]}
        />
