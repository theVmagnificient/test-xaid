          ...
          <div className="container-xaid max-w-3xl mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { stat: '2026', label: 'RSNA Radiology study', sub: 'DOI 10.1148/radiol.252590' },
              ].map((s) => (
        ...
        <article className="section-padding bg-[#EBEBEB]">
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
                In an accompanying editorial, Paola Clauser, MD, PhD, of the Medical University of Vienna, wrote that <a href="https://pubs.rsna.org/doi/10.1148/radiol.261855" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">"while the use of AI can improve workflows and efficiency and maintain good diagnostic performance, the risk of automation bias needs to be considered."</a> She added that "current evidence suggests that less experienced readers are more prone to automation bias, while more experienced readers seem to be more capable of identifying wrong suggestions," and urged particular care in preparing residents and young radiologists.
              </p>
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
