        ...
        <section className="section-padding bg-white/5">
          <div className="container-xaid max-w-3xl mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { stat: '37.1%', label: 'Top-comprehensiveness rate', sub: 'Claude 3.5 Sonnet indications' },
                { stat: '6.6%', label: 'Top-comprehensiveness rate', sub: 'original clinician indications' },
                { stat: '68.1% vs 50%', label: 'Top-factuality rate', sub: 'LLM vs. clinician indication' },
