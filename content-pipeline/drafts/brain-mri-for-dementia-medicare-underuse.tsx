        ...
        <article className="section-padding bg-[#EBEBEB]">
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                MRI use specifically was even more uneven: the initial scan was an MRI in about 29% of cases overall, with lower MRI shares among dual-eligible and Medicare Advantage beneficiaries — meaning the patients least likely to get any scan were also less likely to get the higher-detail modality when they did. Mattke and co-authors were blunt about what this means: <a href="https://radiologybusiness.com/topics/healthcare-management/healthcare-policy/structural-brain-imaging-substantially-underused-medicare-population" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">"Gaps in care were even more pronounced in Medicare Advantage enrollees and dually eligible beneficiaries, a highly socioeconomically vulnerable group."</a>
              </p>
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
                The JACR study doesn't isolate a single cause for the gap, and the authors call for <a href="https://www.jacr.org/article/S1546-1440(26)00447-3/abstract" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">"sustained efforts to improve adherence to clinical guidelines and ensure equitable access to recommended diagnostic evaluations."</a> But the shape of the disparity is telling. It isn't random, and it doesn't look like ordering physicians are simply deciding, case by case, that imaging isn't warranted for nearly half of patients. It concentrates in exactly the populations most likely to face scheduling, access, and follow-through friction: dual-eligible beneficiaries juggling multiple coverage systems, Medicare Advantage enrollees inside narrower networks, and — based on other Medicare geographic-access research — beneficiaries further from an imaging center or a radiologist able to read the exam promptly.
              </p>
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
