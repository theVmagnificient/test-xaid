        ...
        <article className="section-padding bg-[#EBEBEB]">
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
                The most consequential finding may be the one about capacity, not funding directly. The researchers cited a separate JACR survey of 47 U.S. academic radiology program directors, <a href="https://radiologybusiness.com/topics/healthcare-management/healthcare-staffing/radiology-residency-programs-have-space-add-more-positions-funding-uncertain" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">reported separately by Radiology Business</a>, in which programs held an average of about <strong>8.5</strong> diagnostic radiology positions each, and about <strong>85%</strong> of directors said they had room to expand — by an average of roughly <strong>2.8</strong> additional positions. Funding, not applicant demand or program capacity, was identified as the primary barrier to actually doing so.
              </p>
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                Taken together, the authors concluded the bottleneck in radiology training capacity may be financial rather than structural, pointing to the <a href="https://radiologybusiness.com/topics/healthcare-management/healthcare-policy/american-college-radiology-resident-physician-shortage-reduction-act" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">Resident Physician Shortage Reduction Act</a> and MedPAC recommendations for targeted GME allocation as legislative avenues that could incorporate specialty-specific workforce data into funding policy. In plain terms: this isn't a shortage of interested applicants or capable programs. It's a shortage of federal dollars earmarked for radiology specifically, inside a 1997-era cap that has never been reopened for specialty rebalancing.
              </p>
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
                The same paper adds a demand-side data point that sharpens the urgency: the authors cite a Medicare-claims analysis of the radiology workforce, published in the <em>American Journal of Roentgenology</em> (<a href="https://doi.org/10.2214/AJR.26.34579" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">AJR</a>) and covered separately by <a href="https://radiologybusiness.com/topics/healthcare-management/healthcare-staffing/attrition-rising-across-all-radiology-subspecialties-some-leaving-workforce-faster-others" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">Radiology Business</a>, showing unadjusted attrition across all radiologists rising from <strong>1.1%</strong> in 2014 to <strong>2.5%</strong> in 2022. Broken out by group, the same analysis found the increase was sharper among subspecialists (<strong>1.4%</strong> to <strong>2.7%</strong>) than generalists (0.9% to 2.2%), and varied more than four-fold by subspecialty — from about 1.0% for vascular/interventional radiology up to 4.3% for cardiothoracic imaging. The direction is the same throughout: imaging utilization keeps climbing while more radiologists leave the workforce each year, and the pipeline meant to replace them is expanding at less than half the rate of medicine overall.
              </p>
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
              ...
              <p className="text-[#757575] text-[13px] leading-[1.6] font-light mt-10">
                Source: Malhotra A, et al., <em>Journal of the American College of Radiology</em> (published July 22, 2026), as reported by <a href="https://radiologybusiness.com/topics/healthcare-management/healthcare-staffing/radiology-sees-substantially-lower-relative-growth-training-capacity-compared-rest-medicine" target="_blank" rel="noopener noreferrer" className="text-[#666] underline hover:text-xaid-blue">Radiology Business</a>. Program-director survey figures via a <a href="https://radiologybusiness.com/topics/healthcare-management/healthcare-staffing/radiology-residency-programs-have-space-add-more-positions-funding-uncertain" target="_blank" rel="noopener noreferrer" className="text-[#666] underline hover:text-xaid-blue">separate Radiology Business report</a>. Attrition figures from a Medicare-claims analysis published in the <em>American Journal of Roentgenology</em>, <a href="https://doi.org/10.2214/AJR.26.34579" target="_blank" rel="noopener noreferrer" className="text-[#666] underline hover:text-xaid-blue">doi.org/10.2214/AJR.26.34579</a>, also covered by <a href="https://radiologybusiness.com/topics/healthcare-management/healthcare-staffing/attrition-rising-across-all-radiology-subspecialties-some-leaving-workforce-faster-others" target="_blank" rel="noopener noreferrer" className="text-[#666] underline hover:text-xaid-blue">Radiology Business</a>. Figures are rounded as reported.
              </p>
