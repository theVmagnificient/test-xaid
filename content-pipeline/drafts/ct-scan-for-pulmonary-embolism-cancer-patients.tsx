        ...
        <section className="pt-32 md:pt-40 pb-10">
          <div className="container-xaid max-w-3xl mx-auto">
            ...
            <p className="text-white/60 text-lg font-light leading-[1.65]">
              A large randomized trial in <em>JAMA</em> shows a simple clinical algorithm can rule out pulmonary embolism in cancer patients without imaging in nearly one in four cases — as safely as scanning everyone. It's a reminder that AI and decision rules are reshaping which CTs happen, and why the scans that remain deserve better reads.
            </p>
          </div>
        </section>
