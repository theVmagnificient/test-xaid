          ...
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                A study from researchers at Radboud University Medical Center and collaborators at Maastricht UMC and University Medical Center Utrecht, published in <a href="https://doi.org/10.1007/s00330-026-12787-y" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2"><em>European Radiology</em></a> and covered by <a href="https://radiologybusiness.com/topics/artificial-intelligence/deep-learning-shines-predicting-incidental-lung-nodules-severity" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">Radiology Business</a>, set out to test that generalization gap directly — across three hospitals instead of one.
              </p>
