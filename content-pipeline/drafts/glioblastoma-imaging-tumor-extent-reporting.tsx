      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <KeyStats
          items={[
            ...
            { stat: '10–30%', label: 'Misread as tumor recurrence', sub: '"pseudoprogression" on MRI' },
