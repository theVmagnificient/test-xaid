...
const MedicalDeviceCybersecurity = () => {
  ...
  return (
    <>
      <Helmet defer={false}>
        <title>Medical Device Cybersecurity: The CISA DICOM Advisory for AI Imaging Buyers | xAID</title>
        ...
        <meta property="og:title" content="Medical Device Cybersecurity: The CISA DICOM Advisory for AI Imaging Buyers | xAID" />
        ...
        <meta name="twitter:title" content="Medical Device Cybersecurity: The CISA DICOM Advisory for AI Imaging Buyers | xAID" />
        ...
        <article className="section-padding bg-[#EBEBEB]">
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                xAID's approach is built for exactly this kind of scrutiny. The <Link to="/blog/foundation-models-vs-narrow-ai-radiology/" className="text-xaid-blue-strong underline underline-offset-2">foundation-model</Link> pipeline produces a structured, comprehensive report draft that a radiologist reviews and signs — a radiologist-in-the-loop model, so no automated output reaches a chart unreviewed. On the security side, the questions above are the ones we expect buyers to ask: how PHI flows, where it is stored, which deployment model fits your network, and how third-party components are tracked and patched. An advisory like this one is not a reason to slow AI adoption; it is a reason to do the due diligence properly and pick a vendor who welcomes the questions.
              </p>
