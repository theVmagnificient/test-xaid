          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "A 2008–2023 analysis of Medicare claims covering 46,533 radiologists and 476,688 radiologist-years, published in the Journal of Vascular and Interventional Radiology, found that the share of radiologists doing any interventional radiology (IR) work fell from 66.9% to 49.6%, while among those who do practice IR, the share concentrating a majority of their work in it rose from 12.6% to 18.5%, and the share with a super-majority (more than 90% IR) more than doubled, from 4.1% to 8.8%."
              }
            },
            {
              "@type": "Question",
        ...
        <article className="section-padding bg-[#EBEBEB]">
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
                The headline trend runs in two directions at once. Fewer radiologists touch IR work at all — the share doing <em>any</em> interventional radiology fell from <strong>66.9%</strong> in 2008 to <strong>49.6%</strong> in 2023 (equivalently, radiologists doing zero IR work rose from 33% to 50%). But among those who still do IR work, they're doing more of it: the share with a <strong>majority</strong> of their work in IR climbed from <strong>12.6%</strong> to <strong>18.5%</strong>, and the share with a <strong>super-majority</strong> (more than 90% IR) <strong>more than doubled</strong>, from <strong>4.1%</strong> to <strong>8.8%</strong>. Radiologists practicing in 2020–2023 had 1.65 times the odds of a super-majority IR workload compared with those practicing in 2008–2011, as reported by <a href="https://www.itnonline.com/content/interventional-radiology-continues-be-increasingly-concentrated-among-fewer-radiologists" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">Imaging Technology News</a>.
              </p>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {[
                      ...
                      ['Super-majority IR work (>90%), among IR practitioners', '4.1%', '8.8%'],
                    ].map((row) => (
