...
const AiMriWaitTimesThroughput = () => {
  const post = {
    title: 'AI Cut a 37-Hospital System’s MRI Wait Times by More Than 50% — But Faster Scans Just Move the Bottleneck',
    dateIso: '2026-07-02',
    date: 'July 2, 2026',
    category: 'Workflow & Throughput',
    readingTime: 7,
    description:
      'A 37-hospital system halved MRI scheduling delays with FDA-cleared acquisition-speed AI, trimming scans from about 40 minutes to about 30. But faster acquisition pushes the constraint downstream to reporting. Here’s the throughput case for pairing acquisition AI with AI report drafting to clear the backlog end-to-end.',
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://xaid.ai/blog/how-ai-cuts-mri-wait-times" />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "How did AI cut a hospital system's MRI wait times by more than 50%?",
              "acceptedAnswer": {
                "@type": "Answer",
        ...
        <section className="pt-32 md:pt-40 pb-10">
          <div className="container-xaid max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white leading-[1.3] mb-6">
              AI cut a 37-hospital system’s MRI wait times by more than 50%.<br />
          ...
          <div className="container-xaid max-w-3xl mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { stat: '~30 min', label: 'New scan time', sub: 'down from ~40 min' },
          ...
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
                Kaiser Permanente, which operates 37 hospitals in California, integrated an FDA-cleared AI application that reduces image noise to accelerate MRI acquisition. The result: scans that used to take about 40 minutes now take about 30, and the system reported cutting MRI wait times by more than 60%, as <a href="https://radiologybusiness.com/topics/medical-imaging/magnetic-resonance-imaging-mri/ai-cuts-hospital-systems-mri-wait-times-more-50" target="_blank" rel="noopener noreferrer" className="text-xaid-blue hover:underline">covered by <em>Radiology Business</em></a>.
              </p>
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                The economics are the point. By shaving roughly a quarter off each scan, locations could book more patients on the <em>same</em> hardware — no new scanners required. That’s the cleanest kind of capacity win: more throughput out of assets you already own. It’s exactly the outcome capacity-constrained imaging departments are chasing.
              </p>
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
                The evidence says yes — with the honest caveat that gains depend on context. In a three-reader pilot study, radiologists who revised AI-generated draft reports cut mean reporting time from <strong>573 to 435 seconds</strong> — roughly a 24% reduction (p=0.003) — with <a href="https://doi.org/10.48550/arXiv.2412.12042" target="_blank" rel="noopener noreferrer" className="text-xaid-blue hover:underline">no statistically significant difference in clinically significant errors between workflows</a>.
              </p>
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                The counterweight is worth stating plainly. A retrospective analysis of <strong>185,044</strong> chest CT reports across two hospitals found AI-assisted reporting <a href="https://doi.org/10.2196/77967" target="_blank" rel="noopener noreferrer" className="text-xaid-blue hover:underline">may initially increase drafting time, with sustained efficiency gains at only one of the two sites</a>. Reporting AI is not a plug-and-play speed button; the payoff is heterogeneous and depends on workflow fit, case mix, and implementation. That’s an argument for choosing the reporting layer as carefully as the acquisition layer — not for skipping it.
              </p>
              ...
              <div className="space-y-6">
                {[
                  {
                    q: "How did AI cut a hospital system's MRI wait times by more than 50%?",
                  ...
                  },
                  {
                    ...
                    a: 'Evidence points in that direction, with caveats. A three-reader pilot study found that revising AI-generated draft reports cut mean reporting time from 573 to 435 seconds (a roughly 24% reduction, p=0.003) with no statistically significant difference in clinically significant errors. A separate real-world analysis of AI triage on chest CT reported turnaround dropping about 32% during work hours (68.9 to 46.7 minutes). Gains are context-dependent and largest under high volume, so results vary by site and workflow.',
                  },
                  {
