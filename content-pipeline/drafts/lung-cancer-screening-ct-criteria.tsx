...
const LungCancerScreeningCtCriteria = () => {
  ...
  return (
    <>
      <Helmet defer={false}>
        <title>Simpler Lung Cancer Screening CT Criteria — More Scans, More Reporting | xAID</title>
        ...
        <meta property="og:title" content="Simpler Lung Cancer Screening CT Criteria — More Scans, More Reporting | xAID" />
        ...
        <meta name="twitter:title" content="Simpler Lung Cancer Screening CT Criteria — More Scans, More Reporting | xAID" />
