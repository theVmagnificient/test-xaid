        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "A study published in the Journal of the American College of Radiology found referring clinicians prefer structured radiology reports over traditional prose-style reports, and associated structured formats with fewer payer denials tied to medical necessity or coding-level questions. Reporting on the same issue, Radiology Business has documented how errors like incorrect laterality, missed IV contrast documentation, or the wrong view count can put reimbursement at risk even when the underlying exam was appropriate."
              }
            },
            {
              "@type": "Question",
