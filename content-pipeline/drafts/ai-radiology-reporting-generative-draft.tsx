  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://xaid.ai/blog/ai-radiology-reporting-generative-draft" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content={post.title} />
        <meta property="og:description" content={post.description} />
        <meta property="og:url" content="https://xaid.ai/blog/ai-radiology-reporting-generative-draft" />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": post.title, "item": "https://xaid.ai/blog/ai-radiology-reporting-generative-draft" }
          ]
        })}</script>
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          ...
          "url": "https://xaid.ai/blog/ai-radiology-reporting-generative-draft",
