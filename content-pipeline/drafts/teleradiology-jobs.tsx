        ...
        <article className="section-padding bg-[#EBEBEB]">
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                That is the model xAID is built on. A foundation model drafts a structured, comprehensive report; xAID's in-house radiologist reviews every preliminary; and the study is delivered ready-to-sign so the reading radiologist signs the final report. The teleradiologist stays firmly in the loop — reviewing, correcting, and signing, not being bypassed. For teleradiology groups, that translates into more studies cleared per reader without proportionally growing headcount; we cover the operational side in our comparison of <Link to="/ai-vs-teleradiology/" className="text-xaid-blue-strong underline underline-offset-2">AI vs traditional teleradiology</Link> and in resources built <Link to="/for-teleradiology-companies/" className="text-xaid-blue-strong underline underline-offset-2">for teleradiology companies</Link>.
              </p>
