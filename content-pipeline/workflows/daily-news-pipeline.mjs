...
- Voice: evidence-led, neutral, no first person, not salesy. Tie to xAID positioning (foundation models / ready-to-sign reports / radiologist-in-the-loop) naturally — but make the ready-to-sign / human-in-the-loop point ONCE (in the "where xAID fits" section or the CTA), not restated across sentences. "ready-to-sign" already implies the client's radiologist signs; do NOT repeat "their radiologist reviews, corrects, and signs" each time — it reads overloaded and over-emphasizes client re-review.
