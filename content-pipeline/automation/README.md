...
Каждый вечер в 19:00 по времени Mac (= 18:00 CET летом) пайплайн сам собирает новости,
...
- **Часовой пояс:** в plist стоит 19:00 локального времени Mac (Москва) = 18:00 CEST. Если сменишь таймзону Mac — поправь `Hour` в plist и перезагрузи агент.
