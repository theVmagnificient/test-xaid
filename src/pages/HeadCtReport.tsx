          ...
          <div className="container-xaid">
            <div className="max-w-3xl">
              ...
              <p className="text-white/60 text-lg font-light leading-[1.65] mb-10 max-w-xl">
                Structured head CT reports generated by AI, reviewed in-house by a European radiologist before delivery. Coverage for stroke, hemorrhage, fractures, and full intracranial assessment. Available 24/7
              </p>
