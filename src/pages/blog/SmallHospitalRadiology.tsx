        ...
        <article className="pt-24">
          ...
          <div className="section-padding">
            <div className="container-xaid max-w-3xl mx-auto">
              ...
              <ul className="list-disc pl-5 my-4 space-y-2">
                <li className="text-white/60 text-[15px] font-light leading-[1.65]"><strong className="text-white">Is a licensed radiologist signing every report?</strong> Yes — a report is only final when a licensed radiologist signs it. xAID delivers a preliminary reviewed by its in-house radiologist; your reading radiologist reviews and signs the final. The AI does not issue reports autonomously.</li>
