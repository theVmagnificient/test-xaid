        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Throughput per radiologist. AI-assisted, radiologist-reviewed reporting lets a radiologist complete more studies in the same working hours by handling the drafting work, with the practice's own radiologist reviewing, correcting, and signing the final report. That raises output without adding headcount cost — the lever left when reimbursement per study isn't reliably growing."
              }
            }
          ]
        })}</script>
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    a: "Throughput per radiologist. AI-assisted, radiologist-reviewed reporting lets a radiologist complete more studies in the same working hours by handling the drafting work, with the practice's own radiologist reviewing, correcting, and signing the final report. That raises output without adding headcount cost — the lever left when reimbursement per study isn't reliably growing.",
                  },
                ].map((item) => (
