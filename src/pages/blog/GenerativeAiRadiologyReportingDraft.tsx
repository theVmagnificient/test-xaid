        ...
        <article className="section-padding bg-[#EBEBEB]">
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
                The reader study is a controlled experiment. A prospective cohort study of nearly <strong>24,000 radiographs</strong>, published in <a href="https://doi.org/10.1001/jamanetworkopen.2025.13921" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2"><em>JAMA Network Open</em></a>, tested the same idea in live clinical workflow. Radiologists using an AI draft saw a <strong>15.5% documentation efficiency gain</strong> — reading time fell from 189.2 to 159.8 seconds across radiograph types — and peer review found <em>no difference in clinical accuracy</em> between AI-assisted and unassisted reports.
              </p>
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                Different institutions, different datasets, same finding: a generative model that drafts and a radiologist who reviews delivers speed without a quality penalty. The separate <a href="https://doi.org/10.1148/radiol.241476" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">diagnostic-accuracy study</a> behind these tools describes their intended role plainly — providing "preliminary interpretations" to support radiologist workflows, not replace them.
              </p>
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                The chest radiograph is where the evidence is cleanest, but the workflow it validates generalizes. The same draft-then-sign loop — AI generates a structured preliminary report, a radiologist reviews, edits, and signs it — is exactly how <Link to="/how-ai-ct-reporting-works/" className="text-xaid-blue-strong underline underline-offset-2">AI CT reporting</Link> works. xAID's <Link to="/blog/foundation-models-vs-narrow-ai-radiology/" className="text-xaid-blue-strong underline underline-offset-2">foundation models</Link> produce a comprehensive, structured draft, xAID's in-house radiologist reviews every preliminary, and the client's reading radiologist gives the final review and signature before anything reaches a patient's chart. The chest X-ray studies aren't a preview of a distant future; they're the operational proof point for a workflow already running on CT — where the model is the first-draft engine and the radiologist remains the reader of record.
              </p>
