            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <div key={s.stat} className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
                  <div className="text-xl md:text-2xl font-medium text-xaid-blue mb-1 break-words">{s.stat}</div>
        ...
        <article className="section-padding bg-[#EBEBEB]">
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                The chest radiograph is where the evidence is cleanest, but the workflow it validates generalizes. The same draft-then-sign loop is exactly how <Link to="/how-ai-ct-reporting-works/" className="text-xaid-blue-strong underline underline-offset-2">AI CT reporting</Link> works. xAID's <Link to="/blog/foundation-models-vs-narrow-ai-radiology/" className="text-xaid-blue-strong underline underline-offset-2">foundation models</Link> produce a comprehensive, structured draft, xAID's in-house radiologist reviews every preliminary, and the client's reading radiologist signs the final before anything reaches a patient's chart. The chest X-ray studies aren't a preview of a distant future; they're the operational proof point for a workflow already running on CT — where the model is the first-draft engine and the radiologist remains the reader of record.
              </p>
