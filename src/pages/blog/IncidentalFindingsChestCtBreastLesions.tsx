        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "The practical fix is structured, whole-scan review — evaluating every anatomic region in the field of view, including breast parenchyma, rather than treating anything outside the ordering complaint as out of scope. AI-assisted image analysis that reviews the whole volume, not just the organ tied to the primary indication, is one way to make that systematic check practical without adding to a radiologist's read time."
              }
            }
          ]
        })}</script>
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    a: "The practical fix is structured, whole-scan review — evaluating every anatomic region in the field of view, including breast parenchyma, rather than treating anything outside the ordering complaint as out of scope. AI-assisted image analysis that reviews the whole volume, not just the organ tied to the primary indication, is one way to make that systematic check practical without adding to a radiologist's read time.",
                  },
                ].map((item) => (
