        ...
        <article className="section-padding bg-[#EBEBEB]">
          <div className="container-xaid">
            <div className="bg-white rounded-2xl p-8 md:p-16 max-w-3xl mx-auto">
              ...
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
                The evidence says yes — with the honest caveat that gains depend on context. In a three-reader pilot study, radiologists who revised <em>simulated</em> AI draft reports cut mean reporting time from <strong>573 to 435 seconds</strong> — roughly a 24% reduction (p=0.003) — with <a href="https://doi.org/10.48550/arXiv.2412.12042" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">no statistically significant difference in clinically significant errors between workflows</a>. (The drafts were GPT-4–generated stand-ins for a production AI system, so the figure previews the effect rather than proving it in the wild.)
              </p>
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-4">
                A separate real-world analysis of AI triage on chest CT found report turnaround time dropped about <strong>32%</strong> during work hours — from <strong>68.9 to 46.7 minutes</strong> (p=0.004) — while off-hours saw only a ~6% change that wasn’t statistically significant, per <a href="https://doi.org/10.48550/arXiv.2510.15237" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">the study’s real-world time-savings analysis</a>. The benefit was largest exactly when it matters: under high volume.
              </p>
              <p className="text-[#444] text-[15px] leading-[1.65] font-light mb-8">
                The counterweight is worth stating plainly. A retrospective analysis of <strong>185,044</strong> chest CT reports across two hospitals found AI-assisted lung-nodule reporting <a href="https://doi.org/10.2196/77967" target="_blank" rel="noopener noreferrer" className="text-xaid-blue-strong underline underline-offset-2">may initially increase drafting time, with sustained efficiency gains at only one of the two sites</a>. Reporting AI is not a plug-and-play speed button; the payoff is heterogeneous and depends on workflow fit, case mix, and implementation. That’s an argument for choosing the reporting layer as carefully as the acquisition layer — not for skipping it.
              </p>
