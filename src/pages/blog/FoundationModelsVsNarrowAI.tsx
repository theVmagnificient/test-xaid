  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://xaid.ai/blog/foundation-models-vs-narrow-ai-radiology" />
                ...
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-center py-3 px-4 text-xaid-blue font-medium">Foundation Model</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={f} className={i % 2 === 0 ? 'bg-gray-50' : ''}>
                        ...
                        <td className="py-3 px-4 text-center text-xaid-blue font-medium">{found}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
