...
const abdomenFaqs = [
  ...
  },
  {
    ...
    a: 'No — xAID is AI-assisted, not autonomous. Every report is reviewed in-house by a European radiologist before delivery. AI handles structured analysis and draft generation; xAID\'s radiologist is accountable for the preliminary report, and your radiologist reviews and signs the final clinical report',
  },
  {
          ...
          <div className="container-xaid">
            <div className="max-w-3xl">
              ...
              <p className="text-white/60 text-lg font-light leading-[1.65] mb-10 max-w-xl">
                Structured abdomen CT reports generated by AI, reviewed in-house by a European radiologist before delivery. Full abdominal cavity coverage — liver to pelvis. Available 24/7
              </p>
