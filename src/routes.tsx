...
export const routeImporters: Record<string, () => Promise<PageModule>> = {
  ...
  '/blog/ct-pancreatitis-organ-failure-ai-prediction': () => import('./pages/blog/CtPancreatitisOrganFailureAiPrediction'),
  '/blog/chest-ct-vertebral-bone-density-brain-aging': () => import('./pages/blog/ChestCtVertebralBoneDensityBrainAging'),
  '/blog/interventional-radiology-workforce-trends': () => import('./pages/blog/InterventionalRadiologyWorkforceTrends'),
  '/blog/ct-contrast-shortage-cost-length-of-stay': () => import('./pages/blog/CtContrastShortageCostLengthOfStay'),
  '/blog/aetna-bundled-prior-authorization-imaging-cancer-care': () => import('./pages/blog/AetnaBundledPriorAuthorizationImaging'),
  ...
  '/blog/medicare-national-coverage-determination-reform': () => import('./pages/blog/MedicareNationalCoverageDeterminationReform'),
  '/blog/portable-mri-icu-reporting-bottleneck': () => import('./pages/blog/PortableMriIcuReportingBottleneck'),
  '/blog/philips-ct-recall-imaging-capacity': () => import('./pages/blog/PhilipsCtRecallImagingCapacity'),
  '/blog/radiology-joint-venture-ai-vendor-control': () => import('./pages/blog/RadiologyJointVentureAiVendorControl'),
  '/blog/mips-value-pathways-radiology': () => import('./pages/blog/MipsValuePathwaysRadiology'),
  ...
  '/blog/reduce-patient-no-shows-radiology': () => import('./pages/blog/ReducePatientNoShowsRadiology'),
  '/blog/radiology-practice-consolidation-wait-times': () => import('./pages/blog/RadiologyPracticeConsolidationWaitTimes'),
  '/blog/radiology-revenue-cycle-management': () => import('./pages/blog/RadiologyRevenueCycleManagement'),
  '/blog/radiology-second-opinion-discrepancy-rate': () => import('./pages/blog/RadiologySecondOpinionDiscrepancyRate'),
  '/blog/radiology-ai-vendor-evaluation-checklist': () => import('./pages/blog/RadiologyAiVendorEvaluationChecklist'),
  '/blog/glioblastoma-imaging-tumor-extent-reporting': () => import('./pages/blog/GlioblastomaImagingTumorExtentReporting'),
  '/blog/incidental-renal-mass-ct-report': () => import('./pages/blog/IncidentalRenalMassCtReport'),
